...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomePage(title: 'Flutter Chess'),
    );
  }
}
...
class _HomePageState extends State<HomePage> {
  ...
  void _onUserMoveAgainstBot(Move move, {bool? isDrop, bool? isPremove}) async {
    ...
    if (position.isCheckmate) {
      setState(() {
        isCheckMate = true; // Şah mat durumunu işaretle & Check to checkmate
      });
    } else {
...
const positions = [
  ...
  "rnbqkbnr/pppppppp/8/3p4/8/6P1/PPPPPP1P/RNBQKBNR b KQkq - 1 1", //TEST BOARD
];
